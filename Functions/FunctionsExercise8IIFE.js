...
var calculateDecimalValueFromOctal = (function (octal) {
    var result = 0;
    var temp = octal;
    var base = 1;
    while (temp) {
...
console.log(calculateDecimalValueFromOctal);        //needs to work when first number is 0
