...
(function () {
    ...
    function ShoppingBag() {
        ...
        //or like this vvv
        /* this.getMostExpensive = function () {
            let highestPrice = Math.max.apply(null, this.listOfProducts.map(element => element.price));
            let mostExpensiveProduct = this.listOfProducts.find(element => element.price == highestPrice);
            return `The most expensive product is: ${mostExpensiveProduct}, and its price is: ${mostExpensivePrice}.`;
        } */
    }
